...
def build_report(metrics: dict, chart_paths: dict, out_path: str,
    ...
    story += _stat_group(
        ...
        [
            ...
            ("Final Score", _fmt(score["final_score"], " pts")),
    ...
    story += _stat_group(
        "Muscle Activity (EMG)",
        [
            ("Contraction Count", _fmt(emg["contraction_count"], " contractions")),
    ...
    story += _stat_group(
        ...
        [
            ...
            ("Mean Speed", _fmt(motion["mean_speed"], "\u00b0/s")),
            ("Peak Speed", _fmt(motion["peak_speed"], "\u00b0/s")),
            ("Movement Smoothness (LDLJ, dimensionless)", _fmt(motion["overall_ldlj"])),
        ],
